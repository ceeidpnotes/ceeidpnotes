...
namespace fy21_simplemtapp.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ILogger<IndexModel> logger, IConfiguration config)
        {
            ...
            Api02Consent = "https://login.microsoftonline.com/organizations/v2.0/adminconsent?client_id=" + Config["Api02:ClientId"] +
                "&redirect_uri=" + Config["Api02:RedirectUri"] +
                "&state=" + Config["AzureAD:RedirectUri"] +
                "&scope=" + _ApiScope;
            WebUIConsent = "https://login.microsoftonline.com/organizations/v2.0/adminconsent?client_id=" + Config["AzureAD:ClientId"] +
                "&redirect_uri=" + Config["AzureAD:RedirectUri"] +
                "&state=" + randomString(5) +
                "&scope=" + Config["Api02:Scope"];
